...
export default function VerticalCTA({
  ...
  return (
    <section id={id} className="py-24 border-t-[3px] border-black bg-black text-[color:var(--cream)]">
      <div className="max-w-3xl mx-auto px-5 text-center">
        <div className="flex flex-wrap justify-center items-center gap-3 text-xs font-mono mb-6">
          <span className="bg-[color:var(--mustard)] text-black px-2 py-1 font-bold tracking-widest">{plazas.toUpperCase()}</span>
        </div>
        ...
        <p className="text-xs text-white/50 mt-6">Te llamo personalmente en 24-48h para agendar demo de 15 min.</p>
      </div>
    </section>
  );
}
