...
import { agentBySlug, type AgentSlug } from "@/lib/agents";

export async function renderAgent(slug: AgentSlug, suggestions: string[], placeholder: string) {
  ...
  return (
    <section>
      ...
      <div className="flex items-end justify-between mb-4 flex-wrap gap-2">
        ...
        <p className="text-xs font-mono text-black/50 max-w-xs text-right">⚠️ {a.statusNote}</p>
      </div>

      <AgentChat
        agent={slug}
        initialMessages={user.chats[slug]}
