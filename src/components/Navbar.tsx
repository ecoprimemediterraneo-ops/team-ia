    ...
    <header className="sticky top-0 z-40 bg-[color:var(--cream)]/95 backdrop-blur border-b-[3px] border-black overflow-visible">
      <nav className="max-w-7xl mx-auto flex items-center justify-between gap-2 px-4 sm:px-5 py-2 overflow-visible">
        ...
        <div className="hidden md:flex items-center gap-6 font-semibold text-sm uppercase tracking-wider">
            ...
            {sectoresOpen && (
              <>
                ...
                <div className="absolute top-full left-0 mt-1 bg-white border-[3px] border-black shadow-[4px_4px_0_#000] min-w-[160px] z-20">
                  ...
                  <a href="/estetica" className="flex items-center gap-2 px-4 py-2.5 text-xs hover:bg-[color:var(--mustard)] font-bold border-t border-black/10" onClick={() => setSectoresOpen(false)}>✨ Estética</a>
                </div>
              </>
            )}
          </div>
          ...
          <a href="/calculadora" className="hover:text-[color:var(--red)] transition-colors">Calculadora</a>
      ...
      {menuOpen && (
        <div className="md:hidden border-t-[3px] border-black bg-[color:var(--cream)] px-4 py-4 space-y-3">
          ...
          <a href="/diagnostico" className="block font-bold text-sm uppercase tracking-wider hover:text-[color:var(--red)]" onClick={() => setMenuOpen(false)}>Diagnóstico</a>
          <a href="/calculadora" className="block font-bold text-sm uppercase tracking-wider hover:text-[color:var(--red)]" onClick={() => setMenuOpen(false)}>Calculadora</a>
          ...
          <a href="/beta" className="block font-bold text-sm uppercase tracking-wider text-[color:var(--red)]" onClick={() => setMenuOpen(false)}>🔒 Solicitar Beta · 6 meses gratis</a>
          ...
          <a href="/estetica" className="block font-bold text-sm uppercase tracking-wider hover:text-[color:var(--red)]" onClick={() => setMenuOpen(false)}>✨ Estética</a>
