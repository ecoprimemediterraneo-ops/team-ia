      ...
      <main className="flex-1">
          ...
          <div className="max-w-4xl mx-auto px-5">
            <div className="card-hard p-5 bg-[color:var(--mustard)]/10">
              <p className="text-sm">
                ...
                Con más de <strong>{ciudad.population} habitantes</strong>, los clínicas dentales de {ciudad.nombre} compiten por los mismos pacientes
        ...
        <section className="py-16 bg-[color:var(--cream)] border-b-[3px] border-black">
          <div className="max-w-4xl mx-auto px-5 text-center">
            <h2 className="font-stencil text-3xl md:text-4xl mb-4">
              9 agentes trabajando por tu negocio en {ciudad.nombre}
            </h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 text-left">
              {[
                ...
                { emoji: "📸", name: "Marta", desc: "Publica en Instagram y Facebook con contenido de tu negocio" },
        ...
        <section className="py-12 border-b-[3px] border-black bg-black text-white">
          <div className="max-w-3xl mx-auto px-5 text-center">
            ...
            <p className="text-white/60 text-sm">— Negocio piloto, Costa del Sol</p>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto px-5">
            <div className="text-center mb-8">
              <h2 className="font-stencil text-3xl md:text-4xl mb-2">
                30 días gratis para negocios de {ciudad.nombre}
              </h2>
