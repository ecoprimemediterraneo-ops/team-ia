    ...
    <>
      ...
      <main className="flex-1 flex items-center justify-center py-20">
        <div className="max-w-2xl mx-auto px-5 text-center">
          ...
          <h1 className="font-stencil text-3xl md:text-5xl mb-4">Página no encontrada</h1>
          <p className="text-lg text-black/70 mb-8">
            Esta página no existe. O la borramos. O nunca existió. Pero tu sistema sigue funcionando igual.
          </p>
