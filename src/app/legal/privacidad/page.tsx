    ...
    <>
      ...
      <main className="flex-1 py-16">
        <article className="max-w-3xl mx-auto px-5 prose prose-stone">
          ...
          <p>AI-Team (en adelante &quot;el Servicio&quot;), gestionado por <strong>Cristóbal Serrano</strong> (Marbella, Málaga · CP 29602). Contacto: <a className="underline" href="mailto:hola@aiteam.marketing">hola@aiteam.marketing</a></p>
